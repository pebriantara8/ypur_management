<?php
$logo  = 'http://dengerin.id/assets/frontend/images/logo.png';
$halo  = "Yth. $nama";
$p_1   = 'Untuk merubah password anda, silahkan masukkan kode dibawah untuk mengkonfirmasi :';
                            ...
                            <tbody>
                                <tr style="background-color: #4CB6CB" >
                                    ...
                                    <td style="display: inline-flex;padding:0;margin:0;line-height:1px;font-size:1px" > 
                                        <img alt="dengerin image" src="<?=$logo?>" style="padding: 10px;height: 50px; width:50px;display:block;" width="32" >
                                        <p style="font-size: 40px;font-family:Helvetica,Arial,sans-serif;font-weight:bold;color:#fff;text-align:left;margin: auto">
                                        Dengerin.id
                                        </p>
                                    </td>
                                    <td></td>
                                    ...
                                    <td >
                                        <table cellspacing="0" cellpadding="0" border="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td  style="margin-top:12px;line-height:1px;border-radius:4px;line-height:12px"  align="left">
                                                        <strong style="font-size:18px;color:#4CB6CB;border-radius:4px;padding:8px 17px;border:1px solid #1da1f2;display:inline-block;">
                                                           <?=$forgot_pwd_code?>
                                                        </strong>
                                                    </td>
                                                </tr>
