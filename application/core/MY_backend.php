...
class MY_backend extends CI_Controller {
	...
	public function confirm_delete_join($table,	$id, $join, $custom=''){
		$order =''; $from='';
		...
		$this->data['delete_row'] = $this->wd_db->get_data_delete_confirmation($table,$id,$del_id,$order,$join);
		$this->data['field_show'] = $join['select'];
