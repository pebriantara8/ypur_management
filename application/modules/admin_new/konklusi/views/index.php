    <section class="content">
      <div class="row">
        <div class="col-md-12">
          ...
          <a href="<?php echo backend_url().this_module() ?>/form" class="btn bg-primary btn-flat btn-sm" title="Tambah Pengguna Baru">Tambah Penyakit Baru</a>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><?php echo $value['nama_konklusi'] ?></td>
